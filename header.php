...
<header class="header">
    <div class="container">
        <a href="<?php echo $lumise->cfg->url; ?>" class="logo">
            <p><img src="./assets/images/logo_login.png" alt="MIH COLLECTION"><strong>MIH COLLECTION </strong></p>
        </a>
        <div class="menu">
        ...
        <div class="menu_mobile">
            <a href="<?php echo $lumise->cfg->url; ?>" class="logo_mobile"><img src="https://www.mihcollection.com/assets/images/logo_new.png" alt=""></a>
