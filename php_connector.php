...
class lumise_connector {
    ...
    public function __construct() {
        ...
        $this->config = array(
            ...
            "upload_path" => '/home/etechgarage/cloth.etechgarage.com/data/',
			"upload_url" => 'http://cloth.etechgarage.com/data/',
            "admin_assets_url" => $url.'core/admin/assets/',
            "admin_url" => $url.'admin.php?',
            
			"database" => array(
                "host" => 'localhost',
                "user" => 'etechgar_alinda',
                "pass" => '64@nseka149002',
                "name" => 'etechgar_mihcollection',
                "prefix" => 'mih_'
            )
		);
	...
	public function update() {
		...
		if (!empty($connector_content)) {
			...
			$connector_content = str_replace(array(
				'/home/etechgarage/cloth.etechgarage.com/data/',
				'http://cloth.etechgarage.com/data/',
				'localhost',
                'etechgar_alinda',
                '64@nseka149002',
                'etechgar_mihcollection',
                'mih_'
			), array(
