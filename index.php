...
?>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="box-info">
                            ...
                            <div class="content">
                                ...
                                <p><?php echo $lumise->lang('On all order over ugx 50,000/='); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="box-info">
                            ...
                            <div class="content">
                                <h4><?php echo $lumise->lang('Customer Satisfaction '); ?></h4>
                                <p><?php echo $lumise->lang(' 100%'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="lumise-list">
            <div class="container">
                <h2><?php echo $lumise->lang('Customize your Order'); ?></h2>
